...
最近はAPI開発しながらコーチングの勉強してます。技書博5では主に日設営・撤収まわりを担当してます。今回は安全第一でコンテンツを練れなかったのが悔やまれます。スタッフ業もあまりできなかったので次回はガッツリやりたい！気づいたら副代表になっていました。普段はマネジメントやWeb開発などをしています。技書博2では読書休憩スペースの設計と手の足りない担当のお手伝いなどをしました。次回も楽しみ！
}
...
\contributor{みなみん}{@sminamino}{images/contributors/minamin.png}{
